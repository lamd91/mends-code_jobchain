...
sed -n '1~4p' temp.txt > temp1.txt
#sed -n '1~2p' temp.txt > temp1.txt
#sed -n '1,8p' temp1.txt > temp2.txt
cut -c25-263 temp1.txt > synDataByObsPts_2.txt # without the first column with times
